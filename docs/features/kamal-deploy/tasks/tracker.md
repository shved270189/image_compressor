...
| T5 | Fail the Configuration check with named missing fields and secrets | tests | Tech Lead | M | T4 | done |
| T6 | Reject committed secrets and production-target mismatch | tests | Tech Lead | S | T1, T4 | done |
